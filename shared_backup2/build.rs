...
//
//         // Link the WebRTC library
//         println!("cargo:rustc-link-search=native={}", webrtc_lib_dir().display());
//         println!("cargo:rustc-link-lib=static=webrtc");
//
...
//         println!("cargo:rustc-link-lib=dylib=c++_shared");
//
//         // Don't generate the version script if we're just building uniffi-bindgen
//         if !env::var("CARGO_BIN_NAME").unwrap_or_default().contains("uniffi-bindgen") {
//             webrtc_sys_build::configure_jni_symbols().unwrap();
//         }
//     }
// }
//
// fn webrtc_lib_dir() -> PathBuf {
...
//         // Configure JNI symbols for WebRTC
//         webrtc_sys_build::configure_jni_symbols().unwrap();
//
//         // You might also want to add these linker flags
//         println!("cargo:rustc-link-lib=static=webrtc");
//         println!("cargo:rustc-link-lib=static=webrtc");
//         println!("cargo:rustc-link-lib=dylib=c++");
//         println!("cargo:rustc-link-lib=dylib=c++_shared");
